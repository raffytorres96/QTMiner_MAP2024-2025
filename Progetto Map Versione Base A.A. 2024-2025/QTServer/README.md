...
| IDE        | (Opzionale) Visual Studio Code |
| Librerie   | Presenti nella cartella `lib/` |

---

## 🚀 Compilazione ed esecuzione

### ▶ Metodo 1 – Con Visual Studio Code
...
### ▶ Metodo 2 – Da terminale (Java CLI)
...
📄 ../report/javadoc/server/index.html

Per consultare la documentazione del Client:
📄 ../report/javadoc/client/index.html

---

> *Questa documentazione è parte integrante del progetto accademico svolto nell’ambito del corso di Metodi di Analisi e Progetto (MAP).*