 ...
 * 
 * <p>Un dataset è composto da:
 * <ul>
 *   <li>Un insieme di esempi (righe), ciascuno rappresentato da un oggetto {@link Example}</li>
 *   <li>Un insieme di attributi (colonne), che possono essere continui ({@link ContinuousAttribute})
 *       o discreti ({@link DiscreteAttribute})</li>
 * </ul>
 * </p>
 * 
 * <p>La classe fornisce funzionalità per:
 * <ul>
 *   <li>Caricare dati da un database relazionale</li>
 *   <li>Accedere agli esempi e agli attributi del dataset</li>
 *   <li>Convertire esempi in tuple ({@link Tuple}) per algoritmi di clustering</li>
 * </ul>
 * </p>
 * 
 * @author [Il tuo nome]
...
public class Data {
    ...
    /**
     * Lista che memorizza gli esempi del dataset.
     * Ogni elemento è un {@link Example} che rappresenta una riga della tabella.
     */
    ...
    /**
     * L'insieme degli attributi che descrivono lo schema del dataset.
     * Ogni attributo può essere continuo o discreto.
     */
    private List<Attribute> attributeSet;
    
    /**
     * Costruttore della classe Data.
     * Carica il dataset da una tabella del database specificata, analizza lo schema
     * e costruisce la rappresentazione interna con attributi ed esempi.
     * 
     * <p>Il costruttore:
     * <ol>
     *   <li>Si connette al database tramite {@link DbAccess}</li>
     *   <li>Carica lo schema della tabella con {@link Table_Schema}</li>
     *   <li>Per ogni colonna, determina se è un attributo continuo o discreto</li>
     *   <li>Carica gli esempi distinti dalla tabella</li>
     *   <li>Verifica che il dataset non sia vuoto</li>
     * </ol>
     * </p>
     * 
     ...
     * @throws EmptySetException se la tabella non contiene dati o colonne
     */
    ...
    /**
     * Restituisce il numero di esempi (righe) presenti nel dataset.
     * 
    ...
    /**
     * Restituisce il numero di attributi (colonne) che compongono lo schema del dataset.
     * 
     ...
     * 
     * @param exampleIndex l'indice dell'esempio (riga) da cui estrarre il valore
     * @param attributeIndex l'indice dell'attributo (colonna) da cui estrarre il valore
     * @return il valore dell'attributo specificato nell'esempio specificato
     * @throws IndexOutOfBoundsException se gli indici sono fuori dai limiti del dataset
     */
    ...
    /**
     * Crea e restituisce un oggetto {@link Tuple} che modella come sequenza di coppie
     * Attributo-Valore l'esempio alla posizione specificata.
     * 
     * <p>Il metodo converte un esempio ({@link Example}) in una tupla ({@link Tuple})
     * creando gli item appropriati (continui o discreti) per ogni attributo.</p>
     * 
     * @param index l'indice della riga (esempio) da convertire in tupla
     * @return un riferimento a un'istanza di {@link Tuple} che modella l'esempio
     * @throws IndexOutOfBoundsException se l'indice è fuori dai limiti del dataset
     */
     ...
     * 
     * <p>La rappresentazione include:
     * <ul>
     *   <li>La prima riga con i nomi degli attributi separati da virgole</li>
     *   <li>Le righe successive con gli esempi, uno per riga, nel formato: indice: valore1,valore2,...</li>
     * </ul>
     * </p>
     * 
     * @return una stringa che rappresenta il dataset completo
     */
     ...
     * Crea un'istanza di Data caricando una tabella di esempio e la stampa a console.
     * 
     * <p>Nota: Sostituire "your_table_name_here" con il nome di una tabella esistente
     * nel database per eseguire il test.</p>
     * 
